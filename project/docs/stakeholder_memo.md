...
## Overview
This project develops and backtests a trading strategy for soybean meal futures using the MACD indicator, specifically focusing on golden cross and death cross signals. The goal is to evaluate whether systematic technical analysis can improve trading performance compared to passive or discretionary approaches.
